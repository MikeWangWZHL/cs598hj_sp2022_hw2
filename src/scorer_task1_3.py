...
import sys
sys.path.append('.')
from format_checker_task1_3 import check_format_task1_task3
...
#   print(gold_labels.keys())
#   print(pred_labels.keys())
...
def evaluate_pred_file(pred_fpath, gold_fpath, CLASSES):
  """
...
if __name__ == '__main__':
  ...
  if validate_files(pred_file, gold_file, CLASSES):
    ...
    macro_f1, micro_f1 = evaluate_pred_file(pred_file, gold_file, CLASSES)
